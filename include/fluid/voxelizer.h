...
namespace fluid {
	...
	public:
		...
		void mark_exterior();
		bool is_interior(const vec3d& pos) const;
		bool is_interior(const vec3s& pos) const;
		bool is_surface(const vec3d& pos) const;
		bool is_surface(const vec3s& pos) const;
		bool is_exterior(const vec3d& pos) const;
		bool is_exterior(const vec3s& pos) const;
