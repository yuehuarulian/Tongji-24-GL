...
namespace GL_TASK
{
    ...
    void FluidScene::setup_scene()
    {
        ...
        auto liquid_model = std::make_shared<Room>("source/model/mesh.obj", liquid_shader, true);
        liquid_model->set_model_matrix(liquid_model_matrix);
        models.push_back(liquid_model);
    }

    void FluidScene::render(const glm::mat4 &projection, const glm::mat4 &view, glm::vec3 &camera_pos)
    {
